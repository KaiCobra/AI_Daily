...
**[StepVAR - 無需訓練，用結構與紋理引導 VAR 模型剪枝，實現高效推理](papers/2026/2026-03/StepVAR/AI_Daily_StepVAR.md)**

VAR 模型推理時後期尺度佔了 75% 的計算量，StepVAR 用 PCA 保護全局結構、高通濾波保留紋理細節，雙標準無訓練剪枝搭配最近鄰特徵傳播，在不損失生成品質的前提下實現 1.4x–2.0x 加速。
