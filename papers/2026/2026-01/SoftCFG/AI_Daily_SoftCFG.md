...
![CFG vs SoftCFG 對比圖](asset/softcfg_figure1_comparison.png)
...
![Guidance Diminishing 問題](asset/softcfg_figure3_guidance_diminishing.png)
...
![SoftCFG 方法架構圖](asset/softcfg_figure6_method_diagram.png)
...
![生成圖像視覺對比](asset/softcfg_figure2_visual_comparison.png)
*圖4：由LuminaGPT-8B生成的圖像對比。標準CFG（左）生成的圖像中出現了不合理的物體融合（如大象鼻子變成了香蕉），而SoftCFG（右）則生成了更為連貫和合理的圖像。*

![Over-guidance 問題示例](asset/softcfg_figure4_over_guidance.png)
