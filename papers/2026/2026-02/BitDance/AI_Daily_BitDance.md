...
![Figure 4: BitDance 完整架構圖](asset/bitdance_figure4_full_architecture.webp)
...
![Figure 3: 二元 Token 採樣架構對比](asset/bitdance_figure3_architecture.webp)
...
![Figure 5: 並行採樣頭對比](asset/bitdance_figure5_parallel_heads.webp)
...
![Table 1: 重建性能表格](asset/bitdance_table1_reconstruction.webp)
...
![Table 2: ImageNet 生成結果表格](asset/bitdance_table2_imagenet_results.webp)
