...
![Modulation Layers and Analysis](./modulation_guidance_analysis.webp)

作者們的分析證實，在傳統設定下，特別是對於長提示詞，CLIP pooled embedding 的影響微乎其微，甚至在某些模型中完全無作用。

![Figure 1: CLIP Influence vs. Prompt Length](./figure1_clip_prompt_length.webp)
...
![Figure 2: Modulation Guidance Examples](./figure2_modulation_guidance_examples.webp)

如上圖所示，Modulation Guidance 能夠實現局部（如頭髮長度）和全域（如汽車風格）的語意變更。

![Figure 3: Dynamic Modulation Guidance](./figure3_dynamic_modulation_guidance.webp)
...
![Table 2: Experiment Results](./table2_experiments_results.webp)

![Figure 5: Qualitative Results](./figure5_qualitative_results.webp)
...
![Figure 4: Attention Analysis](./figure4_attention_analysis.webp)
